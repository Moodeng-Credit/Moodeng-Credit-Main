...
- **Top ¾ of the page stays HIPPO-FREE for now (George, 2026-07-05 evening).** The section hippos built in the credibility batch (community trio, dark-section lock hippo, ladder trophy) are COMMENTED OUT in index.html, not deleted — one-line restore when George decides mascot placement (likely after the hero exists). Only the team thumbs-up (~86% down) and final-CTA party hippo (~91%) remain visible.
