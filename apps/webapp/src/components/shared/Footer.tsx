...
export default function Footer() {
  ...
  return (
    <footer className="flex overflow-hidden flex-col justify-center items-center px-16 py-32 w-full bg-azure-600 max-md:px-5 max-md:py-24 max-md:max-w-full sticky top-full">
          ...
          <div className="flex flex-col w-[40%] max-md:ml-0 max-md:w-full">
            <div className="flex grow gap-2 items-end text-white max-md:mt-10">
              <div className="flex flex-col items-start self-stretch">
                ...
                <p className="self-stretch mt-5 text-lg leading-tight text-neutral-100 max-md:mr-2.5">
                  FUTURE OF ONCHAIN CREDIT
                </p>
          ...
          <div className="flex flex-col ml-5 w-[20%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col text-white max-md:mt-10">
              ...
              <nav className="flex flex-col mt-5 text-base leading-relaxed">
                ...
                <Link
                  to="/benefits"
                  className="mt-3 hover:text-blue-300 transition-colors"
                >
                  Benefits
                </Link>
                <Link
