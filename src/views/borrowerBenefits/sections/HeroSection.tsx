...
export default function HeroSection(): JSX.Element {
   return (
      <div className="flex overflow-hidden flex-col items-center px-20 mt-2 w-full max-md:px-5 max-md:mt-10 max-md:max-w-full">
         <div className="flex overflow-hidden flex-col items-start px-20 pt-16 pb-28 max-w-full bg-emerald-400 rounded-[60px] text-zinc-900 w-[1440px] max-md:px-5 max-md:pb-24">
