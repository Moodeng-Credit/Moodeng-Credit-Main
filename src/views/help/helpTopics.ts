...
export type HelpCategoryId = 'getting-started' | 'verify' | 'wallet' | 'money-in' | 'cash-out' | 'credit' | 'writing-request' | 'safety';
...
export const HELP_CATEGORIES: HelpCategory[] = [
   ...
   },
   {
      id: 'credit',
      emoji: '📈',
      label: { en: 'Credit & Pandesal points', fil: 'Credit at Pandesal points' },
...
export const HELP_TOPICS: HelpTopic[] = [
   ...
   },
   {
      ...
      question: {
         en: "I signed up but I'm still not verified — what do I do?",
         fil: 'Naka-sign up na ako pero hindi pa verified — ano ang gagawin ko?'
      },
      steps: {
         en: [
            'In the app, tap "Verify Yourself".',
   ...
   // ─── Cashing out ──────────────────────────────────────────────────────────
   {
      ...
      guide: {
         ...
         label: { en: 'Withdrawing to a bank account', fil: 'Pag-withdraw sa bank account' }
      },
   ...
   },
   {
      ...
      guide: {
         ...
         label: { en: 'Trust-Building vs Credit-Building', fil: 'Trust-Building vs Credit-Building' }
      },
   ...
   },
   {
      ...
      category: 'credit',
      emoji: '🧾',
      title: { en: 'How repayments affect your points', fil: 'Epekto ng bayad sa Pandesal points' },
      ...
      guide: {
         ...
         label: { en: 'How repayments affect your points', fil: 'Epekto ng bayad sa Pandesal points' }
      },
      keywords: ['trust points', 'pandesal points', 'scoring', 'on time', 'late', 'default']
   },
   {
      id: 'referral-code',
      category: 'credit',
   ...
   },
   {
      ...
      question: {
         en: '"Make Your Request" does nothing when I tap it — why?',
         fil: 'Walang nangyayari kapag na-tap ko ang "Make Your Request" — bakit?'
      },
      intro: {
   ...
   },
   {
      ...
      guide: {
         ...
         label: { en: 'Managing your account', fil: 'Pag-manage ng account' }
      },
