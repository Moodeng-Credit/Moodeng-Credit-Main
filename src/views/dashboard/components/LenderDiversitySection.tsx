...
export default function LenderDiversitySection({ score, fundedLoans, isVerified, username }: LenderDiversitySectionProps) {
   ...
   const diversityHref = username ? `/user/${encodeURIComponent(username)}/lender-diversity` : '/dashboard';
   ...
   return (
      <div className="bg-md-neutral-100 rounded-md-lg p-4 shadow-md-card">
         <div className="flex items-center justify-between mb-3">
            ...
            <Link to={diversityHref} className="text-md-b3 font-medium text-md-blue-600 underline">
               {linkLabel}
            </Link>
         </div>
