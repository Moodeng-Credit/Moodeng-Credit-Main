...
describe('buildLoanNotificationEmail', () => {
   it('builds a funded email', () => {
      ...
      expect(result.text).toContain('Pandesal points to earn: +20 pts');
   ...
   it('builds a weekly digest email', () => {
      ...
      expect(result.text).toContain('Pandesal points note: Open Moodeng to review available milestones.');
      expect(result.text).toContain('support@moodeng.app');
      ...
      expect(result.html).toContain('Pandesal points');
   ...
   it('builds a repayment received email', () => {
      ...
      expect(result.text).toContain('Pandesal points earned: +20 pts');
      ...
      expect(result.html).toContain('Pandesal points earned');
      expect(result.html).toContain('+20 pts');
      expect(result.html).not.toContain('123 pts');
      expectSupportChannels(result.html);
