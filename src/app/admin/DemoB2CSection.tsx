...
const demoPages: Record<DemoB2CKey, DemoB2CPage> = {
   dashboard: {
      ...
      blurb: 'The redesigned borrower home, gamified Atome-style. Moodeng Town that grows with your credit level, a "Feed Moodeng" daily hook, milestones with food-voucher rewards, and refer-a-friend — all woven into the existing Pandesal points, Credit Level and Dues sections. Localized for the Philippines (Taglish, ₱, GrabFood / Jollibee / GCash). No live data.',
   ...
   assets: {
      ...
      blurb: 'Every graphic used in the borrower dashboard mockup, with one-click downloads: the town/mascot scene art plus the full 10-icon milestone set (160×160 transparent PNG). Includes palette and format notes for whoever builds it.',
   ...
   return (
      <section className="space-y-6">
         ...
         <div className="rounded-2xl border border-amber-400/40 bg-amber-400/10 px-5 py-3 text-lg text-amber-200">
            <span className="font-black">Mock page.</span> Hand-built static HTML, no Supabase data, every figure invented. Sharable link
            for freelancers — the URL itself says <span className="font-mono">mockup</span>.
         </div>
