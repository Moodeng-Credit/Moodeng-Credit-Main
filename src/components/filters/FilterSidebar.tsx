               ...
               <div className="flex gap-1.5 px-md-4 pb-3 overflow-x-auto">
                  {tabs.map((tab) => (
                     <button
                        ...
                        className={`shrink-0 appearance-none rounded-[10px] border px-3.5 py-2 text-md-b3 font-medium whitespace-nowrap transition-all duration-150 [-webkit-tap-highlight-color:transparent] active:scale-[0.98] active:border-[#C9A7FF] active:bg-[#F7F2FF] focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[#C7A6FF] ${
                           activeTab === tab.id
...
function FilterChip({ label, selected, onClick }: { label: string; selected: boolean; onClick: () => void }) {
   return (
      <button
         ...
         className={`relative flex min-h-[54px] w-full appearance-none items-center justify-center rounded-[10px] border px-4 py-2.5 pr-7 text-center text-md-b3 font-medium transition-all duration-150 [-webkit-tap-highlight-color:transparent] active:scale-[0.98] active:border-[#C9A7FF] active:bg-[#F7F2FF] focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[#C7A6FF] ${
            selected
