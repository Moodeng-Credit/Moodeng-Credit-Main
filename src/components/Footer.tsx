               ...
               <div className="flex flex-col ml-5 w-[20%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col text-white max-md:mt-10">
                     ...
                     <nav className="flex flex-col mt-5 text-base leading-relaxed">
                        ...
                        <Link href="/benefits" className="mt-3 hover:text-blue-300 transition-colors">
                           Benefits
                        </Link>
                        <Link href="/guide" className="mt-3 hover:text-blue-300 transition-colors">
                           Guide
                        </Link>
                        <Link href="/whylend" className="mt-3 hover:text-blue-300 transition-colors">
                           Why Lend
                        </Link>
                     </nav>
                  </div>
