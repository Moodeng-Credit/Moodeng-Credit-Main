...
export type Database = {
   ...
   public: {
      Tables: {
         ...
         loans: {
            Row: {
               ...
               repayment_status: Database['public']['Enums']['repayment_status'] | null;
      ...
      Functions: {
         ...
         submit_voucher_claim: {
            Args: {
               p_reward: string;
               p_friend_referral_id: string | null;
               p_full_name: string;
               p_mobile: string;
               p_email?: string | null;
            };
      ...
      Enums: {
         loan_notification_type: 'funded' | 'urgent_reminder' | 'final_reminder' | 'overdue' | 'weekly_digest' | 'repayment_received';
