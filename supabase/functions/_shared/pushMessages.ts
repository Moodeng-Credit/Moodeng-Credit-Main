...
export type DuePushContext = {
   ...
   totalAmount: number;
   /** Localised "24 hours" / "3 days" phrase, already rendered by the caller. */
   dueLabel: string;
};
   ...
   const copy: Record<PushLocale, Record<typeof type, { title: string; body: string }>> = {
      en: {
         final_reminder: {
            ...
            body: isMulti
               ? `${context.loanCount} repayments are due within ${context.dueLabel}. Pay on time to keep your credit level.`
               : `Your repayment is due within ${context.dueLabel}. Pay on time to keep your credit level.`
         },
         urgent_reminder: {
            title: `${amount} USDC due soon`,
            body: isMulti
               ? `${context.loanCount} repayments are due in ${context.dueLabel}. Tap to repay early and stay on track.`
               : `Due in ${context.dueLabel}. Tap to repay early and stay on track.`
         },
         overdue: {
      ...
      fil: {
         final_reminder: {
            ...
            body: isMulti
               ? `May ${context.loanCount} bayarin sa loob ng ${context.dueLabel}. Magbayad on time para hindi bumaba ang credit level mo.`
               : `Due na sa loob ng ${context.dueLabel}. Magbayad on time para hindi bumaba ang credit level mo.`
         },
         urgent_reminder: {
            title: `${amount} USDC, malapit nang due`,
            body: isMulti
               ? `May ${context.loanCount} bayarin sa loob ng ${context.dueLabel}. Mag-tap para magbayad nang maaga.`
               : `Due sa loob ng ${context.dueLabel}. Mag-tap para magbayad nang maaga.`
         },
         overdue: {
      ...
      id: {
         final_reminder: {
            ...
            body: isMulti
               ? `${context.loanCount} pembayaran jatuh tempo dalam ${context.dueLabel}. Bayar tepat waktu agar credit level tetap aman.`
               : `Jatuh tempo dalam ${context.dueLabel}. Bayar tepat waktu agar credit level tetap aman.`
         },
         urgent_reminder: {
            title: `${amount} USDC segera jatuh tempo`,
            body: isMulti
               ? `${context.loanCount} pembayaran jatuh tempo dalam ${context.dueLabel}. Ketuk untuk bayar lebih awal.`
               : `Jatuh tempo dalam ${context.dueLabel}. Ketuk untuk bayar lebih awal.`
         },
         overdue: {
