...
-- Grant permissions to allow the Edge Function (using service_role or authenticated) to call it
GRANT EXECUTE ON FUNCTION public.ensure_email_identity(UUID, TEXT) TO service_role;
GRANT EXECUTE ON FUNCTION public.ensure_email_identity(UUID, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.ensure_email_identity(UUID, TEXT) TO anon;
